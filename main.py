...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            try:
                ...
                if not vacancies:
                    ...
                    for vac in vacancies:
                        ...
                        print(f"Ссылка: {url}")
                        print(
                            f"Требования: {vacancy_obj.requirement}"
            ...
            keyword = input(
                "Введите поисковый запрос для фильтрации (оставьте пустым для всех): "
            ).strip()
            try:
                vacancies = api._connect_apy(keyword)
                ...
                sorted_vacancies = sorted(
                    vacancy_objects,
                    key=lambda v: v.salary if isinstance(v.salary, int) else 0,
                    reverse=True,
                )
            ...
            keyword_in_desc = (
                input("Введите ключевое слово для поиска в описании вакансии: ")
                .strip()
                .lower()
            )
            ...
            try:
                ...
                for vac in vacancies:
                    ...
                    if description and keyword_in_desc in description.lower():
                        ...
                        salary_info = vac.get("salary")
                        vacancy_obj = WorkVacancies(
                            name, url, salary_info, requirement=""
                        )
